...
import { ACADEMY_HERO_SLIDES } from './academyHeroData.js';

/**
 * AcademyHeroSlider — same behaviour as the homepage HeroSlider,
 * using the Academy's own images so the two heroes stay independent.
 */
