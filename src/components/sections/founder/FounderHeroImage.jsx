...
import { Lightbulb, Sprout, Rocket, ShieldCheck } from 'lucide-react';
import { FOUNDER_HERO_IMAGE, FOUNDER_HERO_IMAGE_STATS, FOUNDER_FEATURE_CARDS } from './founderHeroData.js';
...
export default function FounderHeroImage() {
  return (
    <motion.div
    ...
    >
      <div className="relative overflow-hidden rounded-3xl border border-navy-100 shadow-premium-lg">
        ...
        >
          {FOUNDER_HERO_IMAGE_STATS.map((stat) => (
      ...
      {FOUNDER_FEATURE_CARDS.map((card, i) => {
